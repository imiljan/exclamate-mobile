...
export type PostPageQueryQuery = { __typename?: 'Query' } & {
  getPost: Maybe<
    { __typename?: 'Post' } & Pick<Post, 'id' | 'body' | 'created' | 'likes'> & {
        ...
        comments: Array<
          Maybe<
            { __typename?: 'Comment' } & Pick<Comment, 'id' | 'body' | 'created'> & {
                user: { __typename?: 'User' } & Pick<
                  User,
...
export type CommentMutation = { __typename?: 'Mutation' } & {
  createComment: { __typename?: 'Comment' } & Pick<Comment, 'id' | 'body' | 'created'> & {
      user: { __typename?: 'User' } & Pick<
        User,
        'id' | 'username' | 'email' | 'firstName' | 'lastName'
      >;
...
export type AddPostMutation = { __typename?: 'Mutation' } & {
  createPost: { __typename?: 'Post' } & Pick<Post, 'id' | 'body' | 'created' | 'likes'> & {
      user: { __typename?: 'User' } & Pick<
        User,
        'id' | 'username' | 'firstName' | 'lastName' | 'email'
      >;
...
export type SearchPageQuery = { __typename?: 'Query' } & {
  getUsers: Array<
    Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'username' | 'firstName' | 'lastName'>>
  >;
};

export type MyProfilePageQueryQueryVariables = {};

export type MyProfilePageQueryQuery = { __typename?: 'Query' } & {
  ...
  > & {
      posts: Maybe<
        Array<Maybe<{ __typename?: 'Post' } & Pick<Post, 'id' | 'body' | 'created' | 'likes'>>>
      >;
    };
};
...
export type UserProfilePageQueryQuery = { __typename?: 'Query' } & {
  getUser: Maybe<
...
export class PostPageQueryGQL extends Apollo.Query<
  PostPageQueryQuery,
...
export class MyProfilePageQueryGQL extends Apollo.Query<
  MyProfilePageQueryQuery,
  MyProfilePageQueryQueryVariables
> {
...
export class UserProfilePageQueryGQL extends Apollo.Query<
